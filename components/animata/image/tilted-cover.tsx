  ...
  return (
    ...
    <div className="flex h-64 w-52 items-center justify-center overflow-hidden">
      <div className="group relative h-52 w-40">
        ...
        <div
          className={cn(
            "border-box pointer-events-none absolute inset-0 h-full w-full rounded-xl border-[3px] bg-white transition-all delay-75 duration-500 ease-slow group-hover:!transform-none group-hover:opacity-0 dark:bg-gray-800",
            {
