...
export default function FaqSection({ data = initialData }: FaqSectionProps) {
  const [openItem, setOpenItem] = useState<string | null>(null);

  return (
    <div
      className="mx-auto max-w-md rounded-lg p-4"
      style={{ maxWidth: "1000px", minWidth: "700px" }}>
      <Pill className="max-w-fit mx-auto mb-6" title="FAQ❓" />
